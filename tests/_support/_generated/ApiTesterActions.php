<?php  //[STAMP] b48e59c7ac451912f3650ffe2ceb66c1
...
trait ApiTesterActions
{
     ...
     * @param $html
     * @return string|null
     * @see \Helper\Api::grabValueFromInputWithNameInHtml()
     */
    public function grabValueFromInputWithNameInHtml($name, $html) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabValueFromInputWithNameInHtml', func_get_args()));
    }
